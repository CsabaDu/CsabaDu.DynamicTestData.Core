...
: TestDataBase(definition)
{
    ...
    => GetOrSubstitute(_result, ResultString);
...
///// </summary>
///// <inheritdoc cref="TestDataBase{T1, T2}"/>
///// <typeparam name="T3">Type of the third test argument.</typeparam>
///// /// <param name="arg3">Third test argument value.</param>
//public class TestDataBase<T1, T2, T3>(
//    string definition,
//    string result,
//    T1? arg1, T2? arg2, T3? arg3)
//: TestDataBase<T1, T2>(definition, result, arg1, arg2)
//{
...
///// </summary>
///// <inheritdoc cref="TestDataBase{T1, T2, T3}" />
///// <typeparam name="T4">The type of the fourth argument.</typeparam>
///// <param name="arg4">The fourth test argument value..</param>
//public class TestDataBase<T1, T2, T3, T4>(
//    string definition,
//    string result,
//    T1? arg1, T2? arg2, T3? arg3, T4? arg4)
//: TestDataBase<T1, T2, T3>(
//    definition,
//    result,
//    arg1, arg2, arg3)
//{
...
///// </summary>
///// <inheritdoc cref="TestDataBase{T1, T2, T3, T4}" />
///// <typeparam name="T5">The type of the fifth argument.</typeparam>
///// <param name="arg5">The fifth test argument value..</param>
//public class TestDataBase<T1, T2, T3, T4, T5>(
//    string definition,
//    string result,
//    T1? arg1, T2? arg2, T3? arg3, T4? arg4, T5? arg5)
//: TestDataBase<T1, T2, T3, T4>(
//    definition,
//    result,
//    arg1, arg2, arg3, arg4)
//{
...
///// </summary>
///// <inheritdoc cref="TestDataBase{T1, T2, T3, T4, T5}" />
///// <typeparam name="T6">The type of the sixth argument.</typeparam>
///// <param name="arg6">The sixth test argument value..</param>
//public class TestDataBase<T1, T2, T3, T4, T5, T6>(
//    string definition,
//    string result,
//    T1? arg1, T2? arg2, T3? arg3, T4? arg4, T5? arg5, T6? arg6)
//: TestDataBase<T1, T2, T3, T4, T5>(
//    definition,
//    result,
...
///// </summary>
//// <inheritdoc cref="TestDataBase{T1, T2, T3, T4, T5, T6}" />
///// <typeparam name="T7">The type of the seventh argument.</typeparam>
///// <param name="arg7">The seventh test argument value..</param>
//public class TestDataBase<T1, T2, T3, T4, T5, T6, T7>(
//    string definition,
//    string result,
//    T1? arg1, T2? arg2, T3? arg3, T4? arg4, T5? arg5, T6? arg6, T7? arg7)
//: TestDataBase<T1, T2, T3, T4, T5, T6>(
//    definition,
//    result,
...
///// </summary>
///// <inheritdoc cref="TestDataBase{T1, T2, T3, T4, T5, T6, T7}" />
///// <typeparam name="T8">The type of the eighth argument.</typeparam>
///// <param name="arg8">The eighth test argument value..</param>
//public class TestDataBase<T1, T2, T3, T4, T5, T6, T7, T8>(
//    string definition,
//    string result,
//    T1? arg1, T2? arg2, T3? arg3, T4? arg4, T5? arg5, T6? arg6, T7? arg7, T8? arg8)
//: TestDataBase<T1, T2, T3, T4, T5, T6, T7>(
//    definition,
//    result,
...
///// </summary>
///// <inheritdoc cref="TestDataBase{T1, T2, T3, T4, T5, T6, T7, T8}" />
///// <typeparam name="T9">The type of the ninth argument.</typeparam>
///// <param name="arg9">The ninth test argument value..</param>
//public class TestDataBase<T1, T2, T3, T4, T5, T6, T7, T8, T9>(
//    string definition,
//    string result,
//    T1? arg1, T2? arg2, T3? arg3, T4? arg4, T5? arg5, T6? arg6, T7? arg7, T8? arg8, T9? arg9)
//: TestDataBase<T1, T2, T3, T4, T5, T6, T7, T8>(
//    definition,
//    result,
